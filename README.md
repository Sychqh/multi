...
![](screenshots/6.png)
![](screenshots/7.png)
Зависят: с увеличением количества воркеров: загрузка памяти увеличивается, загрузка процессора увеличивается, загрузка сети не меняется, время работы уменьшается. 
