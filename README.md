...
![](screenshots/1.png)
### Нагрузка и время асинхронной проверки ссылок с 5 воркерами
![](screenshots/2.png)
![](screenshots/3.png)
### Нагрузка и время асинхронной проверки ссылок с 10 воркерами
![](screenshots/4.png)
![](screenshots/5.png)
### Нагрузка и время асинхронной проверки ссылок со 100 воркерами
![](screenshots/6.png)
![](screenshots/7.png)
### Зависимость:
с увеличением количества воркеров: загрузка памяти уменьшается, загрузка процессора увеличивается, время работы уменьшается. 

## CPU-bound
### Скорость генерации 1 монеты на 1 ядре
Больше 40 минут, не дождался
### Нагрузка и время асинхронной генерации с 2 воркерами
![](screenshots/8.png)
![](screenshots/9.png)
### Нагрузка и время асинхронной генерации с 10 воркерами
![](screenshots/10.png)
![](screenshots/11.png)
### Зависимость:
с увеличением количества воркеров: загрузка памяти увеличивается, загрузка процессора увеличивается,
